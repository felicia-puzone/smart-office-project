...
class Operator:
    ...
    def extract_data(self, nv_path, array, columns, label):
    ...
    def convert_data(self, input_arr, target, nv_path):
        if target == 0:
            # user_temp
            return self.extract_data(nv_path, input_arr, ['user_age',
                                                          'user_sex',
                                                          'user_task',
                                                          'ext_temp',
    ...
    def from_temp_idx(self, idx, uq_path):
        unique_values = []
    ...
    def from_flask_in(self, data_in, target, nv_path):
        norm_samples = []
        norm_values = []
        ...
        if target == 0:
            ...
            norm_samples = self.normalize_data(conv_data, norm_values)
            ...
            norm_samples.append(self.normalize_data(conv_data, norm_values))
